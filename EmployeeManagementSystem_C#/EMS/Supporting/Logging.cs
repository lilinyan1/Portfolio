...
* \date 11-21-2014
* \brief contain the logics of the methods of the Logging class
*/
using System;
...
namespace Supporting
{
    ...
    public class Logging
    {
        ...
        /// 
        public void Log(string className, string methodName, string sEvent, bool result)
        {
        ...
        /// 
        private string LogBuilder(string className, string methodName, string sEvent, bool result)
        {
            string sResult = "";
            // get date & time
        ...
        /// 
        private bool WriteToFile(string log)
        {
